...
mixin _$PersonModel {
  ...
  @JsonKey(name: 'json_resp')
  List<String> get jsonResp => throw _privateConstructorUsedError;
...
abstract class $PersonModelCopyWith<$Res> {
  ...
  $Res call(
      {String? name,
      int age,
      @JsonKey(name: 'json_resp') List<String> jsonResp});
}
    ...
    return _then(_value.copyWith(
      ...
      age: null == age
          ...
          : age // ignore: cast_nullable_to_non_nullable
              as int,
      jsonResp: null == jsonResp
          ? _value.jsonResp
          : jsonResp // ignore: cast_nullable_to_non_nullable
              as List<String>,
    ) as $Val);
  }
}
...
class _$PersonModelImpl implements _PersonModel {
  _$PersonModelImpl(
      {this.name = '',
      this.age = 0,
      @JsonKey(name: 'json_resp') final List<String> jsonResp = const []})
      : _jsonResp = jsonResp;
  ...
  @JsonKey()
  final int age;
  final List<String> _jsonResp;
  @override
  @JsonKey(name: 'json_resp')
  List<String> get jsonResp {
    if (_jsonResp is EqualUnmodifiableListView) return _jsonResp;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_jsonResp);
  }

  @override
  String toString() {
    return 'PersonModel(name: $name, age: $age, jsonResp: $jsonResp)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._jsonResp, _jsonResp));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(
      runtimeType, name, age, const DeepCollectionEquality().hash(_jsonResp));
...
abstract class _PersonModel implements PersonModel {
  factory _PersonModel(
          {final String? name,
          final int age,
          @JsonKey(name: 'json_resp') final List<String> jsonResp}) =
      _$PersonModelImpl;
